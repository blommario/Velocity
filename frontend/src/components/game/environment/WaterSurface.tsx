/**
 * WaterSurface — Animated water/lava plane with TSL vertex displacement + flow.
 *
 * Uses MeshStandardNodeMaterial with:
 *  - Vertex displacement via layered sine waves
 *  - Flow-direction scrolling UVs
 *  - Emissive glow for lava variant
 *  - Transparent with depth-write off for correct alpha blending
 *
 * Game-level component — imports from engine are OK.
 */
...
import { fbm2D } from '../../../engine/rendering/tslNoise';
import type { WaterSurfaceData } from '../map/types';
