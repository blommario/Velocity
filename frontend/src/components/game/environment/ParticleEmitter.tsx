/**
 * ParticleEmitter — Map-placed particle emitter using existing presets.
 *
 * Each emitter spawns GPU particles from a fixed world position using one of
 * the defined particle presets (smoke, sparks, ash, dust, etc.).
 *
 * Uses <primitive> for R3F scene graph integration (not manual scene.add).
 * Wind and position use TSL uniform() nodes — updating them does NOT rebuild
...
import type { ParticleEmitterData } from '../map/types';
